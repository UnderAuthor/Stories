...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Stories " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"Storiestools.com", "dnsseed.Storiestools.com"},
    {"Storiespool.org", "dnsseed.Storiespool.org"},
    {"xurious.com", "dnsseed.str.xurious.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"Storiestools.com", "testnet-seed.Storiestools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Stories is probably already running."), addrBind.ToString().c_str());
        else
